    ...
    try:
        ...
        if response.status_code == 200:
            ...
            "basic_info": {
                ...
                "bio": parsed_data["9"]["data"]["9"]["data"] if "9" in parsed_data else None,
        ...
        if "8" in parsed_data and "2" in parsed_data["8"]["data"]:
            player_data["animal"] = {"name": parsed_data["8"]["data"]["2"]["data"]}
        else:
            player_data["animal"] = None

        if "6" in parsed_data and "2" in parsed_data["6"]["data"]:
            player_data["guild"] = {
        ...
        return jsonify({"status": "success", "message": "Player information retrieved", "data": player_data})
